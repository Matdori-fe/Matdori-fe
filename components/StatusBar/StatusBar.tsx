...
export default function StatusBar({
  ...
  return (
    <div className="w-[121px] h-[42px]">
      <NormalGage name="음식 맛" score={Number(flavorRating.toFixed(1))} />
      <NormalGage name="가성비" score={Number(underPricedRating.toFixed(1))} />
      <NormalGage name="청결" score={Number(cleanRating.toFixed(1))} />
    </div>
  );
}
// REFACTOR:
