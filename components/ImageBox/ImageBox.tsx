...
const ImageBox:React.FC<ImageBoxType> = ({url,size,className}) =>{
    ...
    if(!size){
        ...
        return(
            <>
                <img src={url} className={`w-[60px] h-[60px] rounded-[15px] object-cover ${className}`}/>
            </>
        )
    }
    else if(size==="medium"){
        return(
            <>
                <img src={url} className={`w-[75px] h-[75px] rounded-[15px] object-cover ${className}`}/>
            </>
        )
    }
    else if(size==="large"){
        return(
            <>
                <img src={url} className={`w-[100px] h-[100px] rounded-[15px] object-cover ${className}`}/>
            </>
        )
    }
