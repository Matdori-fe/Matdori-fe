import {RiHome5Line,RiHome5Fill,RiSearch2Line,RiSearch2Fill,RiBook3Line,RiBook3Fill,RiUser2Line,RiUser2Fill} from 'react-icons/ri'
...
const NavigationBar:React.FC = () =>{
    ...
    return(
    <>
        <div className="w-100 h-auto flex justify-around border-t border-lightgray pt-[10px]">
            {/*홈 컴포넌트*/}
            ...
            {/*검색 컴포넌트*/}
            <div className='w-[28px] h-[39px] flex flex-wrap justify-center items-center' onClick={()=>clickFun(1)}>
            ...
            {/*족보 컴포넌트*/}
            <div className='w-[28px] h-[39px] flex flex-wrap justify-center items-center' onClick={()=>clickFun(2)}>
            ...
            {/*My 컴포넌트*/}
            <div className='w-[24px] h-[39px] flex flex-wrap justify-center items-center' onClick={()=>clickFun(3)}>
